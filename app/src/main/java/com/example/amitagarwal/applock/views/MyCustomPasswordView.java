...
public class MyCustomPasswordView extends RelativeLayout{
	...
	public MyCustomPasswordView(Context context) {
		super(context,null);
	}

	public MyCustomPasswordView(Context context,OnClickListener listener) {
		super(context,null);
	...
	private class LastRow extends LinearLayout{
		...
		public LastRow(Context context) {
			...
			TextView goToHome = new TextView(context);
			goToHome.setText(CustomViewConstants.GO_HOME);
			goToHome.setTag(CustomViewConstants.GO_HOME);
			goToHome.setLayoutParams(new LayoutParams((int) CustomViewConstants.BUTTON_WIDTH,CustomViewConstants.BUTTON_HEIGHT));
			goToHome.setBackgroundResource(R.drawable.button_selector);
			goToHome.setTextSize(TypedValue.COMPLEX_UNIT_SP, 30);
			goToHome.setTypeface(null, Typeface.BOLD);
			goToHome.setTextColor(getResources().getColor(R.color.black));
			goToHome.setGravity(Gravity.CENTER);
			goToHome.setOnClickListener(listener);
			addView(goToHome);
